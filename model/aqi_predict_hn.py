...
joblib.dump(model, '/Users/buihung/VT/project1/model/aqi_model_hn.pkl')
print("✅ Mô hình đã lưu thành 'aqi_model_hn.pkl' với feature last_hour_aqi")


# ====== STEP 3: Giả lập dữ liệu online và dự đoán (Serving) ======
print("\n🎯 Kiểm thử dự đoán online:")
model = joblib.load("/Users/buihung/VT/project1/model/aqi_model_hn.pkl")
