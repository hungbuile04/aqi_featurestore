...
# ===== STEP 1: Kết nối Feast và lấy dữ liệu từ Offline Store (BigQuery) =====
print("🔗 Kết nối Feature Store...")

store = FeatureStore(repo_path=".")

# Tạo entity dataframe cho entity_id '20.75_106.75'
entity_df = pd.DataFrame({
    "entity_id": ["20.75_106.75"] * 100,
    "event_timestamp": pd.date_range(start="2025-05-01", periods=100, freq="H")
})

# Truy vấn historical features từ Feast (lấy từ BigQuery)
...
# ===== STEP 5: Lưu model =====
model_path = '/Users/buihung/VT/project1/model/aqi_model_hp.pkl'
...
last_hour_aqi = online_features["aqi"][0]  # Giả lập realtime AQI trước đó
