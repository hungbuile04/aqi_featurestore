...
# Tạo entity dataframe cho entity_id '20.5_106.25'
entity_df = pd.DataFrame({
    "entity_id": ["20.5_106.25"] * 100,
...
# ===== STEP 5: Lưu model =====
model_path = '/Users/buihung/VT/project1/model/aqi_model_tb.pkl'
